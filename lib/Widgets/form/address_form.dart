...
import 'package:flutter_getx_wireframe/Widgets/form/searchable_dropdown.dart';
...
class _AddressFormState extends State<AddressForm> {
  ...
  Future readJson() async {
    ...
    final states = findStatesByCountryCode(
        jsonData, widget.address?.country ?? "United States");
            ...
            return Column(
              ...
              children: [
                fieldItem['isShowing'] == true
                    ...
                    : Container(),
                SizedBox(
                  height: fieldItem['isShowing'] == true ? 10 : 0,
                ),
                (fieldItem['name'] == 'country' || fieldItem['name'] == 'state')
                    ? fieldItem['isShowing'] == true
                        ? SearchableDropdown(
                            items: fieldItem['name'] == 'state'
                                ? countryState
                                : data,
              ...
              child: PrimaryButton(
                onPressed: () {
                  if (_formKey.currentState!.saveAndValidate()) {
                    ...
                    if (isStateRequired()) {
                      AppToast.show(context, "${tr.state} ${tr.isRequired}");
                      return;
                    } else {

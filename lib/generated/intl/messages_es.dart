...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) => "بيانات فارغة ${value}";

  static String m1(seconds) => "إعادة إرسال الرمز خلال ${seconds}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "apartmentOptional": MessageLookupByLibrary.simpleMessage(
      "شقة، جناح، إلخ.",
    ),
    "apartmentOptionalValue": MessageLookupByLibrary.simpleMessage(
      "شقة، جناح، إلخ (اختياري)",
    ),
    "areYouSure": MessageLookupByLibrary.simpleMessage("هل أنت متأكد؟"),
    "areYouSureDetails": MessageLookupByLibrary.simpleMessage(
    ...
    "connectivityStatusError": MessageLookupByLibrary.simpleMessage(
      "تعذر الحصول على حالة الاتصال:",
    ),
    ...
    "deviceOffline": MessageLookupByLibrary.simpleMessage(
      "جهازك غير متصل حالياً",
    ),
    "deviceOnline": MessageLookupByLibrary.simpleMessage("جهازك متصل الآن"),
    ...
    "letsLogin": MessageLookupByLibrary.simpleMessage(
      "لنقم بتسجيل الدخول باستخدام بياناتك",
    ),
    "letsSignUp": MessageLookupByLibrary.simpleMessage("لنقم بإنشاء حساب"),
    ...
    "neverMind": MessageLookupByLibrary.simpleMessage("لا بأس"),
    ...
    "otpIncorrect": MessageLookupByLibrary.simpleMessage("رمز التحقق غير صحيح"),
    ...
    "phoneOptional": MessageLookupByLibrary.simpleMessage("الهاتف (اختياري)"),
    ...
    "searchResultFor": MessageLookupByLibrary.simpleMessage("نتائج البحث عن"),
    ...
    "state": MessageLookupByLibrary.simpleMessage("المحافظة/الولاية"),
    "success": MessageLookupByLibrary.simpleMessage("نجح"),
    "termsAndConditions": MessageLookupByLibrary.simpleMessage(
      "الشروط والأحكام",
    ),
    "tryAgain": MessageLookupByLibrary.simpleMessage("يرجى المحاولة مرة أخرى"),
